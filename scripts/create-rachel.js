...
async function createAssistant() {
  ...
  const res = await fetch('https://api.vapi.ai/assistant', {
    ...
    body: JSON.stringify({
      name: 'Rachel — FB Home & Auto Intake v2.0',
      ...
      voice: {
        provider: '11labs',
        voiceId: 'Ne7VRnu9eE7lobTDr8Pw' // Placeholder shared voice — distinctive voice per agent is a known TODO
      },
      transcriber: {
        provider: 'deepgram',
        model: 'nova-2',
  ...
  if (data.id) {
    console.log('Rachel assistant created successfully!');
