...
→ Call `transferCall` with `destination: "FB Live Agent Handoff v1.0"`.
...
- `FB Live Agent Handoff v1.0` → existing quote, existing policy, caller requests a person, or confusion fallback
